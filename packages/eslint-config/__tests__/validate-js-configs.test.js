...
describe('Validate JS configs', () => {
  it('Validate etc-fe-eslint-config', async () => {
  ...
  it('Validate etc-fe-eslint-config/es5', async () => {
  ...
  it('Validate etc-fe-eslint-config/vue', async () => {
  ...
  it('Validate etc-fe-eslint-config/essential', async () => {
  ...
  it('Validate etc-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate etc-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate etc-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate etc-fe-eslint-config/node', async () => {
