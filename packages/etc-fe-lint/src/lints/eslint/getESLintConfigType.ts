 ...
 * @param cwd
 * @param pkg
 * @returns etc-fe-eslint-config/index
 * @returns etc-fe-eslint-config/react
 * @returns etc-fe-eslint-config/typescript/index
 * @returns etc-fe-eslint-config/typescript/react
 */
